...
function handleWsMessage(msg) {
  ...
  switch (msg.type) {
    ...
    case 'alertAcknowledged': {
      ...
      allAudit.unshift({ timestamp: now, category: 'incident', action: `Incident ${msg.alertId} acknowledged`, performedBy: msg.userId || 'Dispatcher', targetUser: '', details: '' });
    ...
    case 'alertResolved': {
      ...
      allAudit.unshift({ timestamp: now, category: 'incident', action: `Incident ${msg.alertId} resolved`, performedBy: msg.userId || 'Dispatcher', targetUser: '', details: '' });
...
function renderIncidents() {
  ...
  document.getElementById('incidentsTableBody').innerHTML = filtered.map(i => `
    <tr>
      ...
      <td>${typeIcons[i.type] || '🚨'} ${i.type.charAt(0).toUpperCase() + i.type.slice(1)}</td>
